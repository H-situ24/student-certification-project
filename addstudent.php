...
<head>
    ...
    <form action="" method="POST" class="frm" enctype="multipart/form-data"><br>
        <h1 id="hh">Add new student</h1>
        ...
        <!-- <table> -->
            <div id="container">
                ...
                <br>
                <tr>
                    <th><label for="f1" id="pic" class="lbl1">photo</label></th>
                    <th><input type="file" id="f1" class="txtt" name="photo"></th>
                </tr>
                <br><br>
                <tr>
                    <input type="submit" id="sub1" class="sub" name="submit" value="AddS">
                </tr>
            </div>
    ...
    if(isset($_POST['submit'])){
        ...
        $q="insert into student values('$sr','$sn','$sp','$name')";

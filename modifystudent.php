...
<head>
    ...
    <style>
        *{
        ...
        .frm{
            height: 400px;
            margin-left: 810px;
            background-color: rgba(25, 42, 117, 0.76);
            width: 500px;
        }
        #hh{
    ...
    <form action="" method="POST" class="frm"><br>
        ...
        <!-- <table> -->
            <div id="container">
                ...
                <br><br>
                <tr>
                    <input type="submit" id="sub1" class="sub" name="submit" value="modifyS">
                </tr>
            </div>
    ...
    if(isset($_POST['submit'])){
        ...
        $sn=$_POST['name'];
        $sp=$_POST['phn'];
        $q="update student set sphn='$sp' where RegNo='$sr'";

...
<head>
    ...
    <style>
        *{
        ...
        .frm{
            height: 400px;
            margin-left: 810px;
            background-color: rgba(11, 11, 102, 0.753);
            width: 500px;
        }
        #hh{
        ...
        <!-- <table> -->
            <div id="container">
                ...
                <tr>
                    ...
                    <th><input type="text" id="txt2" class="txtt" name="ename"></th>
                </tr>
                <br>
                <tr>
                    <th><label for="" id="fee" class="lbl1">PhoneNo</label></th>
                    <th><input type="text" id="txt3" class="txtt" name="ephn"></th>
                </tr>
                <br><br>
                <tr>
                    <input type="submit" id="sub1" class="sub" name="submit" value="UpdateE">
                </tr>
            </div>
    ...
    if(isset($_POST['submit'])){
        ...
        $ename=$_POST['ename'];
        $ephone=$_POST['ephn'];
        $q="update employee set ephn='$ephone' where eid='$eid'";

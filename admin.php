    ...
    <nav id="navbar">
        ...
        <ul id="under">
            ...
            <li class="list" id="l2"><a href="" class="anchr" id="a2">course</a>
                <div class="subcon4">
                    <ul id="under5">
                        <li class="lis" id="ll1"><a href="http://localhost/hubnet/addcourse.php">addC</a></li>
                        <li class="lis" id="ll2"><a href="http://localhost/hubnet/modifycourse.php">modify</a></li>
                        <li class="lis" id="ll3"><a href="http://localhost/hubnet/deletecourse.php">delete</a></li>
                        <li class="lis" id="ll4"><a href="http://localhost/hubnet/Cfind.php">find</a></li>
                    </ul>
                </div>
            </li>

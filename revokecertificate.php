...
<head>
    ...
    <form action="" method="POST" class="frm"><br>
        <h1 id="hh">revoke certificate form</h1>
        <hr style="background-color: black; width: 90%; margin-left: 27px;">
        <!-- <table> -->
            <div id="container">
                <tr>
                    <th><label for="txt1" id="cn" class="lbl1">certificate No.</label></th>
                    <th><input type="text" id="txt1" class="txtt" name="cno" placeholder="Enter certificate no..."></th>
                </tr>
                <br>
                <tr>
                ...
                <br><br>
                <tr>
                    <input type="submit" id="sub1" class="sub" name="submit" value="Submit">
                </tr>
            </div>    
        <!-- </table> -->
    </form>

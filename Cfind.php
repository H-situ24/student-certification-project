...
<head>
    ...
    <nav id="navbar">
        <img src="hub.png" alt="" style="height: 70px; width: 100px; margin-top: 3px; background-color: antiquewhite;">
        <ul id="under">
    ...
    <?php
        ...
        if(isset($_POST['find'])){
            $cname=$_POST['course'];
            $q="select * from course where name='$cname'";
    ...
    ?>
    <form action="" method="POST" id="frm"><br>
        <h1>find course</h1>
        <hr>
        <!-- <table> -->
        <div id="container">
                <tr>
                    <th><label for="" id="cor" class="lbl1">course</label></th>
                    <th><input type="text" id="txt1" class="txtt" name="course" placeholder="Enter course name"></th>
                </tr>
                <br>
                <tr>
                    <th><label for="" id="dur" class="lbl1">duration</label></th>
                    <th><input type="text" id="txt2" class="txtt" name="duration" value="<?php
                    if($d!=""){
                        echo $d;
                    }
                    else{
                ...
                <br>
                <tr>
                    <th><label for="" id="fee" class="lbl1">fee</label></th>
                    <th><input type="text" id="txt3" class="txtt" name="fee" value="<?php 
                    if($f!=""){
                        echo $f;
                    }
                    else{
            ...
            <br>
            <tr>
                <input type="submit" id="sub1" class="sub" name="find" value="Find">
            </tr>

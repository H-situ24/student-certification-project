...
<head>
    ...
    <form action="" method="POST" id="frm"><br>
        ...
        <div id="container">
                ...
                <tr>
                    ...
                    <th><input type="text" id="txt2" class="txtt" name="duration" placeholder="Enter course duration"></th>
                </tr>
                <br>
                <tr>
                    <th><label for="" id="fee" class="lbl1">fee</label></th>
                    <th><input type="text" id="txt3" class="txtt" name="fee" placeholder="Enter course fee"></th>
                </tr>
            <br>
            <tr>
                <input type="submit" id="sub1" class="sub" name="modify" value="Modify">
            </tr>
    ...
    if(isset($_POST['modify'])){
        ...
        $cdd=$_POST['duration'];
        $cff=$_POST['fee'];
        $q="update course set fee='$cff' where name='$cnn'";

...
<head>
        ...
        <!-- <table> -->
            <div id="container">
                <tr>
                    ...
                    <th><input type="text" id="txt1" class="txtt" name="eid" placeholder="Enter employeeId..."></th>
                </tr>
                <br>
                <tr>
                    <th><label for="" id="dur" class="lbl1">name</label></th>
                    <th><input type="text" id="txt2" class="txtt" name="ename" placeholder="Enter employee name..."></th>
                </tr>
                <br>
                <tr>
                    <th><label for="" id="fee" class="lbl1">PhoneNo</label></th>
                    <th><input type="text" id="txt3" class="txtt" name="ephn" placeholder="Enter phone no."></th>
                </tr>
                <br><br>
                <tr>
                    <input type="submit" id="sub1" class="sub" name="submit" value="AddE">
                </tr>
            </div>
    ...
    if(isset($_POST['submit'])){
        ...
        $en=$_POST['ename'];
        $ep=$_POST['ephn'];
        $q="insert into employee values('$ei','$en','$ep')";
